...
public class OneMElioonAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<SahamListModel> items;
    private Context context;

    public OneMElioonAdapter(List<SahamListModel> items, Context context) {
        this.items = items;
    ...
    @NonNull
    @Override
    public ViewHolderOneMElioon onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sahm_list, parent, false);

        return new ViewHolderOneMElioon(view);
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        final ViewHolderOneMElioon vh = (ViewHolderOneMElioon) holder;
...
class ViewHolderOneMElioon extends RecyclerView.ViewHolder {
    TextView list_group;
    TextView title_sahm;
    TextView list_count;
    TextView live_price;
    ...
    public ViewHolderOneMElioon(@NonNull View itemView) {
        super(itemView);
